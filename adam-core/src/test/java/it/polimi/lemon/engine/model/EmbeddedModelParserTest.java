...
import it.polimi.lemon.model.Requirement.Policy;
...
public class EmbeddedModelParserTest {
	...
	public void testGetInitialState(){
		assertEquals("it.polimi.lemon.app.ClassWithImplementations.one",embeddedModel.getInitialState());
	}
	...
	public void testGetStates(){
		...
		State stateOne = states.get("it.polimi.lemon.app.ClassWithImplementations.one");
		assertNotNull(stateOne);
		assertEquals("it.polimi.lemon.app.ClassWithImplementations.one", stateOne.getName());
		...
		assertEquals("it.polimi.lemon.app.ClassWithImplementations.hasAutoFocus", stateOne.getTransitionCondition());
		
		List<Connection> connections = stateOne.getConnections();
		assertEquals(2, connections.size());
		assertEquals("it.polimi.lemon.app.ClassWithImplementations.two", connections.get(0).getState().getName());
		assertEquals("it.polimi.lemon.app.ClassWithImplementations.three", connections.get(1).getState().getName());
	...
	public void testGetStates2(){
		...
		State stateTwo = states.get("it.polimi.lemon.app.ClassWithImplementations.two");
		assertNotNull(stateTwo);
		assertEquals("it.polimi.lemon.app.ClassWithImplementations.two", stateTwo.getName());
		...
		assertEquals("it.polimi.lemon.app.ClassWithImplementations.three", connections.get(0).getState().getName());
